...
public:
	...
	{
    	value = atoi(GetProperty(properties, key).c_str());    
	}
    
	static void GetProperty(long& value, Properties& properties, std::string key)
	{
    	value = atol(GetProperty(properties, key).c_str());    
	}
    
	static void GetProperty(double& value, Properties& properties, std::string key)
	{
    	value = atof(GetProperty(properties, key).c_str());    
	}
    
	static std::string GetProperty(Properties& properties, std::string key)
	{
	...
	{
		std::cout << msg << " channel { id:"<< GetProperty(properties, "id") <<", name:"<<CUtil::GetProperty(properties, "channelName")<<" }" <<std::endl ;
	}
	...
	{
		sleep(atof(GetProperty(properties, "sleep").c_str()));
	}
};
